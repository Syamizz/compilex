...
$chapter  = 4;
$page     = 10;
$nextPage = "c5_1.php"; // adjust as needed
    ...
    <div class="note-container">
        ...
        <nav class="toc">
            ...
            <ul>
                ...
                <li><a href="#exercises"    class="toc-link">Exercises 4.10</a></li>
            </ul>
        ...
        <article class="content">
            ...
            <section id="intro">
                ...
                <p>
                    ...
                    The program is written in Java and is available at
                    <code>http://www.rowan.edu/~bergmann/books</code>.
                </p>
...
{   <span class="kw">if</span> (token.<span class="fn">get_class</span>() == <span class="str">'('</span>)
    ...
    <span class="kw">else</span>  <span class="cm">// check for unary operators +, - ...</span>
            ...
            <section id="exercises">
                <h2><span class="sec-icon">📝</span> Exercises 4.10</h2>

                <div class="algo-block">
                    <div class="algo-block-header">Exercise 1 — Atom Output for a Decaf Statement</div>
                    <div class="algo-block-body">
                        <p style="font-size:13.5px;">
                            Show the atoms put out as a result of the following Decaf statement:
                        </p>
                        <div class="code-block" style="font-size:13px; line-height:2;">
<span class="kw">if</span> (a==3) { a = 4;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="kw">for</span> (i = 2; i&lt;5; i=0 ) i = i + 1;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
<span class="kw">else</span> <span class="kw">while</span> (a&gt;5) i = i * 8;
                        </div>
                    </div>
                </div>

                <div class="algo-block">
                    <div class="algo-block-header">Exercise 2 — Purpose of Each Atom in the <code>for</code> Statement</div>
                    <div class="algo-block-body">
                        <p style="font-size:13.5px;">
                            Explain the purpose of each atom put out in the Decaf attributed translation
                            grammar for the <code>for</code> statement:
                        </p>
                        <div class="grammar-box" style="font-size:12.5px; line-height:2.1;">
                            <span class="nt">ForStmt</span>
                            <span class="arr">→</span>
                            <span class="kw">for</span>
                            <span class="t">(</span>
                            <span class="nt">OptExpr<sub class="attr">p</sub></span>
                            <span class="t">;</span>
                            <span class="act">{LBL}<sub class="attr">Lbl1</sub></span>
                            <span class="nt">OptBoolExpr<sub class="attr">Lbl3</sub></span>
                            <span class="t">;</span><br>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <span class="act">{JMP}<sub class="attr">Lbl2</sub></span>
                            <span class="act">{LBL}<sub class="attr">Lbl4</sub></span>
                            <span class="nt">OptExpr<sub class="attr">r</sub></span>
                            <span class="t">)</span>
                            <span class="act">{JMP}<sub class="attr">Lbl1</sub></span><br>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <span class="act">{LBL}<sub class="attr">Lbl2</sub></span>
                            <span class="nt">Stmt</span>
                            <span class="act">{JMP}<sub class="attr">Lbl4</sub></span>
                            <span class="act">{LBL}<sub class="attr">Lbl3</sub></span><br>
                            <span class="comp">Lbl1 = newlab()&nbsp;&nbsp;Lbl2 = newlab()&nbsp;&nbsp;Lbl3 = newlab()&nbsp;&nbsp;Lbl4 = newlab()</span>
                        </div>
                    </div>
                </div>

                <div class="algo-block">
                    <div class="algo-block-header">Exercise 3 — Adding a <code>switch</code> Statement</div>
                    <div class="algo-block-body">
                        <p style="font-size:13.5px;">
                            The Java language has a <code>switch</code> statement.
                        </p>
                        <ol style="font-size:13.5px; line-height:2; padding-left:20px;">
                            <li>Include a definition of the <code>switch</code> statement in the attributed
                                translation grammar for Decaf.</li>
                            <li>Check your grammar by building an attributed derivation tree for a sample
                                <code>switch</code> statement of your own design.</li>
                            <li>Include code for the <code>switch</code> statement in the recursive descent
                                parser, <code>decaf.java</code> and <code>parse.java</code>.</li>
                        </ol>
                    </div>
                </div>

                <div class="algo-block">
                    <div class="algo-block-header">Exercise 4 — Attributed Derivation Tree</div>
                    <div class="algo-block-body">
                        <p style="font-size:13.5px;">
                            Using the grammar of Figure 4.19, show an attributed derivation tree for the
                            statement given in Exercise 1 above.
                        </p>
                    </div>
                </div>

                <div class="algo-block">
                    <div class="algo-block-header">Exercise 5 — <code>do-while</code> Statement</div>
                    <div class="algo-block-body">
                        <p style="font-size:13.5px;">
                            Implement a <code>do-while</code> statement in Decaf, following the guidelines
                            in Exercise 3.
                        </p>
                    </div>
                </div>
            ...
            <div class="chapter-nav">
                <a href="c4_9.php" class="nav-btn">
                    <span>←</span>
                    <div><span class="btn-sub">Previous</span>4.9 Translating Control Structures</div>
                </a>
