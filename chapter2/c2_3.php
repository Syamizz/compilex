...
<head>
  ...
  <style>
    ...
    *::after {
    ...
    .mc-bad .mc-complexity {
      background: #FFF1F2;
      color: #9F1239;
    }

    .mc-mid .mc-complexity {
      background: #FFFBEB;
      color: #92400E;
    }

    .mc-good .mc-complexity {
      background: #F0FDF4;
      color: #065F46;
    }
          ...
          <div class="quiz-body">
            ...
            <div class="quiz-options" id="q1-opts">
              <div class="quiz-opt" onclick="answer(this,'q1',false)">
                <div class="opt-circle">A</div> O(n)
              </div>
              <div class="quiz-opt" onclick="answer(this,'q1',false)">
                <div class="opt-circle">B</div> O(n log n)
              </div>
              <div class="quiz-opt" onclick="answer(this,'q1',true)">
                <div class="opt-circle">C</div> O(n²) — each new word must be compared against all previous entries
              </div>
              <div class="quiz-opt" onclick="answer(this,'q1',false)">
                <div class="opt-circle">D</div> O(log n)
              </div>
            </div>
          ...
          <div class="quiz-body">
            ...
            <div class="quiz-options" id="q2-opts">
              <div class="quiz-opt" onclick="answer(this,'q2',false)">
                <div class="opt-circle">A</div> 2047 comparisons
              </div>
              <div class="quiz-opt" onclick="answer(this,'q2',false)">
                <div class="opt-circle">B</div> 1024 comparisons
              </div>
              <div class="quiz-opt" onclick="answer(this,'q2',true)">
                <div class="opt-circle">C</div> 12 comparisons — log₂(2047) + 1 ≈ 11 + 1
              </div>
              <div class="quiz-opt" onclick="answer(this,'q2',false)">
                <div class="opt-circle">D</div> 22 comparisons
              </div>
            </div>
          ...
          <div class="quiz-body">
            ...
            <div class="quiz-options" id="q3-opts">
              <div class="quiz-opt" onclick="answer(this,'q3',false)">
                <div class="opt-circle">A</div> Bucket 0 — (3 + 98) % 6 = 101 % 6 = 0
              </div>
              <div class="quiz-opt" onclick="answer(this,'q3',false)">
                <div class="opt-circle">B</div> Bucket 4 — (3 + 98) % 6 = 101 % 6 = 4
              </div>
              <div class="quiz-opt" onclick="answer(this,'q3',true)">
                <div class="opt-circle">C</div> Bucket 5 — (3 + 98) % 6 = 101 % 6 = 5
              </div>
              <div class="quiz-opt" onclick="answer(this,'q3',false)">
                <div class="opt-circle">D</div> Bucket 2 — (3 + 98) % 6 = 101 % 6 = 2
              </div>
            </div>
          ...
          <div class="quiz-body">
            ...
            <div class="quiz-options" id="q4-opts">
              <div class="quiz-opt" onclick="answer(this,'q4',false)">
                <div class="opt-circle">A</div> It always uses less memory than a BST
              </div>
              <div class="quiz-opt" onclick="answer(this,'q4',true)">
                <div class="opt-circle">B</div> The structure does not depend on the insertion order of words — it is consistent regardless of the sequence encountered
              </div>
              <div class="quiz-opt" onclick="answer(this,'q4',false)">
                <div class="opt-circle">C</div> It allows words to be stored in alphabetical order automatically
              </div>
              <div class="quiz-opt" onclick="answer(this,'q4',false)">
                <div class="opt-circle">D</div> It is easier to implement than sequential search
              </div>
            </div>
          ...
          <div class="quiz-body">
            ...
            <div class="quiz-options" id="q5-opts">
              <div class="quiz-opt" onclick="answer(this,'q5',false)">
                <div class="opt-circle">A</div> A perfectly balanced tree with O(n log n) build time
              </div>
              <div class="quiz-opt" onclick="answer(this,'q5',true)">
                <div class="opt-circle">B</div> A degenerate tree resembling a linked list, with O(n²) build time
              </div>
              <div class="quiz-opt" onclick="answer(this,'q5',false)">
                <div class="opt-circle">C</div> A complete binary tree with O(n) build time
              </div>
              <div class="quiz-opt" onclick="answer(this,'q5',false)">
                <div class="opt-circle">D</div> A hash table with O(1) average lookup time
              </div>
            </div>
