...
<span class="line" data-idx="14">    } } }</span></code></pre>
            ...
            <section id="series">
                ...
                <table class="compare-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>1st loop</td>
                            <td>term×π²/1/2 ≈ 4.935</td>
                            <td>+1</td>
                            <td>1 + (-1)(4.935) = -3.935</td>
                            <td>3</td>
                        </tr>
                        <tr>
                            <td>2nd loop</td>
                            <td>prev×π²/3/4 ≈ 4.058</td>
                            <td>-1</td>
                            <td>-3.935 + (1)(4.058) = 0.123</td>
                            <td>5</td>
                        </tr>
                        <tr>
                            <td>…</td>
                            <td>…getting smaller…</td>
                            <td>alternates</td>
                            <td>converges to cos(π) ≈ -1</td>
                            <td>…</td>
                        </tr>
                    </tbody>
                </table>
            ...
            <div class="chapter-nav">
                <a href="c1_4_1.php" class="nav-btn">
                    <span>←</span>
                    <div><span class="btn-sub">Previous page</span>1.4.1 Features vs Java</div>
                </a>
                <a href="?complete=19" class="nav-btn next">
                    <div style="text-align:right"><span class="btn-sub">Next page</span>1.4.3 The Mini Target Machine</div>
                    <span>→</span>
                </a>
            </div>
