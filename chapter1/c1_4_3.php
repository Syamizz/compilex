  ...
  <div class="note-container">
    ...
    <article class="content">
      ...
      <div class="chapter-nav">
        <a href="c1_4_2.php" class="nav-btn">
          <span>←</span>
          <div><span class="btn-sub">Previous page</span>1.4.2 The Cosine Program</div>
        </a>
        <a href="?complete=20" class="nav-btn next">
          <div style="text-align:right"><span class="btn-sub">Next page</span>1.4.4 Valid Decaf Segments</div>
          <span>→</span>
        </a>
      </div>
